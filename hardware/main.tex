...
Brew Master 9000\par % Book title
\vspace*{1cm}
{\Large Iver Egge\\
Kristoffer Dalby\\
Johan Slettvold\\
...
These are the most common gaskets that are available. They will degrade over time if used with strong acids. As they stick very well to metal, they provide an excellent seal.

\subsubsection{EPDM rubber}

Temperature rating of $-34\degree$C \textasciitilde $149\degree$C.\\
They have better chemical resistance than silicone gaskets and will last longer than silicone gaskets. As the name implies they are a type of rubber and therefor soft and somewhat sticky.
...
These fittings should not be over tightened as this will ruin the compression ring and therefor the seal.
